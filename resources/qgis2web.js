...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [1498343.943175, 5689034.334444, 1554246.921969, 5719678.711234], maxZoom: 20, minZoom: 10
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([1498343.943175, 5689034.334444, 1554246.921969, 5719678.711234], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_SlovenskaParanzana_1,
    colName: 'name',
    zoom: 10,
    collapsed: true,
    map: map
